require 'rspec'
require_relative '../../src/ruby_core_ext/symbol'

describe Symbol do

  it 'should correctly identify an atomic method name' do
  ...
  it 'should return the non-atomic name of an atomic method name correctly' do
  ...
  it 'should return the atomic name of a non-atomic method name correctly' do
